...
<div class="d-flex">
  ...
  <section id="edit_pesanan" class=" admin-content">
    ...
    <br>
        ...
        <label for="title"><h5>Gambar/Sketsa </h5></label>
            ...
            <div class="slides-1 portfolio-details-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    ...
                    <div class="swiper-slide ">
                        <img src="{{ asset('storage/image-orders/' . $image_order->image) }}" alt=""  class="img-fluid mx-auto d-block" style="max-height: 400px">
                    </div>
                        @endforeach
