    ...
    <div class="line-title mb-6"></div>
            ...
            <div class="slides-1 portfolio-details-slider swiper">
                <div class="swiper-wrapper align-items-center">
                    ...
                    <div class="swiper-slide">
                        <img class="img-fluid mx-auto d-block" src="{{ asset('storage/image-events/' . $image_event->image) }}" alt="" style="max-height: 400px">
                    </div>
                        @endforeach
        ...
        <div class="row justify-content-between gx-1" style="margin-top: 120px">
            ...
            <div class="col-lg-3">
                <div class="">
                    <ul>
                        <li>tanggal event<h5> <strong> {{$event->date_event}}</strong> </h5></li>
                        <li>Lokasi<h5> <strong> {{$event->location}}</strong> </h5></li>
                        <li>Waktu<h5> <strong> {{$event->time}}</strong> </h5></li>
