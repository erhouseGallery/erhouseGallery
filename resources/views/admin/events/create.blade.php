...
<section id="buat_karya" class="admin-content">
    ...
    <div class="input-dashboard">
        ...
        <input type="text" class="form-control @error('location') is-invalid @enderror border-16" id="location" name="location" placeholder="Lokasi" required autofocus>
        @error('location')
            <div class="invalid-feedback">
                {{ $message }}
                </div>
    ...
    <div class="input-dashboard">
        ...
        <input type="text" class="form-control @error('time') is-invalid @enderror border-16" id="time" name="time" placeholder="waktu" required autofocus>
        @error('time')
            <div class="invalid-feedback">
                {{ $message }}
                </div>
