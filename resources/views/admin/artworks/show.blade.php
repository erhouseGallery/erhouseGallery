            ...
            <div class="row justify-content-between gx-1 " style="margin-top: 120px">
                ...
                <div class="col-lg-3">
                    <div class="">
                        ...
                        <ul>
                            <li class="mb-3">Ukuran :<h5> <strong> {{ $artwork->size }}</strong> </h5>
                            </li>
                            <li class="mb-3">Bahan :<h5> <strong> {{ $artwork->material }}</strong> </h5>
                            </li>
                            <li class="mb-3">Tahun :<h5> <strong> {{ $artwork->year }}</strong> </h5>
                            </li>
                            <li class="mb-3">Harga :<h5> <strong> {{ $artwork->price }}</strong> </h5>
                            </li>
                        </ul>
                    </div>
                </div>
